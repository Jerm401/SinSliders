    ...
    <section className="min-h-screen bg-midnight py-20 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        >
          ...
          <div className="bg-black/50 p-8 rounded-lg mb-8">
            <h2 className="text-2xl font-bold text-gold mb-4">Gameplay Overview</h2>
            <ol className="list-decimal pl-6 text-white/90">
              <li>Each player (sinner) starts by drawing 3 Sin Cards.</li>
              <li>One player becomes the Pope for the round (highest die roll).</li>
              <li>Each sinner plays a Sin Card face down.</li>
              <li>The Pope shuffles and ranks the sins from least (Venial) to most (Mortal).</li>
              <li>Players may debate and influence the Pope's judgment.</li>
              <li>The most severe sins receive a Mortal Sin Token and a Curse Card.</li>
              <li>The least severe sins receive a Mercy Token and a Blessing Card.</li>
              <li>The Pope excommunicates one player, preventing them from confessing that round.</li>
              <li>Other players may confess to remove Mortal Sins (rolling a 4-6 succeeds).</li>
              <li>A new Pope is assigned, and players refill their hands to 3 cards.</li>
            </ol>
          </div>
